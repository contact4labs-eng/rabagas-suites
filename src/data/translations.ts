...
export const t: Translations = {
  ...
  'origin.beat1': { en: '<em class="rabagas-mark">Rabagas</em> was a Sardou play before it was a man. Paris, 1872 — a comedy about a populist who sold his radicalism for a ministry. The Greek translation was banned. Six years later, a Sifnian journalist took the title for his own satirical weekly. The name stuck to him.', el: '<em class="rabagas-mark">Ραμπαγάς</em> ήταν θεατρικό του Σαρντού πριν γίνει άνθρωπος. Παρίσι, 1872 — μια κωμωδία για έναν λαϊκιστή που πούλησε τον ριζοσπαστισμό του για ένα υπουργείο. Η ελληνική μετάφραση απαγορεύτηκε. Έξι χρόνια αργότερα, ένας Σιφνιός δημοσιογράφος δανείστηκε τον τίτλο για το δικό του σατιρικό φύλλο. Το όνομά του έμεινε.', fr: '<em class="rabagas-mark">Rabagas</em> était une pièce de Sardou avant d’être un homme. Paris, 1872 — une comédie autour d’un populiste qui troqua son radicalisme contre un ministère. La traduction grecque fut interdite. Six ans plus tard, un journaliste sifniote emprunta le titre pour sa propre feuille satirique. Le nom lui resta.' },
